...
ActionMap::ActionMap()
    : entries_ {{
        ...
        { "brake", juce::KeyPress(juce::KeyPress::leftKey) },
        ...
        { "layer_down", letter(',') }, { "exhaust_preset", letter(';') },
        { "clutch_hold", letter('Y') }, { "clutch_decrease", letter('T') }, { "clutch_increase", letter('U') },
