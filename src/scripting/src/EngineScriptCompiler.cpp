...
const GlobalNumericProperty* findGlobalNumericProperty(std::string_view path) noexcept {
    static const GlobalNumericProperty properties[] {
        ...
        { "exhaust_afterfire.enabled", Dimension::dimensionless, [](auto& c, double v) { c.exhaustAfterfire.enabled = v != 0.0; } },
        { "exhaust_afterfire.ignition_temperature_c", Dimension::temperature, [](auto& c, double v) { c.exhaustAfterfire.ignitionTemperatureK = v + 273.15; } },
        { "exhaust_afterfire.reaction_time_constant_s", Dimension::time, [](auto& c, double v) { c.exhaustAfterfire.reactionTimeConstantSeconds = v; } },
        { "exhaust_afterfire.reaction_efficiency", Dimension::dimensionless, [](auto& c, double v) { c.exhaustAfterfire.reactionEfficiency = v; } },
        { "exhaust_afterfire.overrun_fuel_fraction", Dimension::dimensionless, [](auto& c, double v) { c.exhaustAfterfire.overrunFuelFraction = v; } },
        { "exhaust_afterfire.overrun_minimum_rpm", Dimension::engineSpeed, [](auto& c, double v) { c.exhaustAfterfire.overrunMinimumRpm = v; } },
        { "exhaust_afterfire.overrun_maximum_throttle", Dimension::dimensionless, [](auto& c, double v) { c.exhaustAfterfire.overrunMaximumThrottle = v; } },
